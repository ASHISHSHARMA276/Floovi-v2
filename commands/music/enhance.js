...
module.exports = {
  ...
  async execute(client, message, args) {
    ...
    if (!player) return message.channel.send({ embeds: [new EmbedBuilder().setColor("#ff0000").setDescription("❌ No music playing.")] });
    ...
    message.channel.send({ 
      embeds: [new EmbedBuilder()
        .setColor("#5865F2")
        .setDescription("✨ **Audio Enhancement Applied!** High-fidelity sound enabled for Premium members.")
      ] 
    });
  },
};
